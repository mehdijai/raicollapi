...
<body>
    <h1>RaïColl</h1>
    <ul id="list"></ul>
    <button disabled id="playButton">Play Audio</button>
    <button disabled id="pauseButton">Pause Audio</button>
        ...
        <div id="player02" class="player horizontal">
            <div class="wrapper">
                ...
                <div class="controls">
                    ...
                    <div class="play" id="playPauseButton">
                ...
                <div class="track-time">
                    <div class="range">
                        <input max="100" min="0" value="0" step="1" type="range"
                            id="trackRange" />
                    </div>
                    <div class="time">
                        <div id="total-time" class="total-time">03:20</div>
                        <div id="last-time" class="last-time">00:12</div>
                    </div>
                </div>
            </div>
        </div>
